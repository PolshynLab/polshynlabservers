...
blacklistedPorts = ['COM1', 'COM2','COM8','COM10']
...
class serialDeviceManager(object):
	...
	def identifyPort(self,port):
		...
		#########################
		## Lake Shore T control##
		#########################

		print("\tTrying device type: LakeShore")
		...
		if response.startswith('LSCI,MODEL372'):
			self.regWrite("lakeshore_372",response,port)
